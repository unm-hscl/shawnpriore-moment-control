function [P_target, P_mav, P_uav] = verify(mean_uavs, mean_mav, Wd_concat, mu_concat, time_horizon, target_sets, r, samples)
...
%   Detailed explanation goes here
    ...
    rng('default');
    disturbed_mean_mav = exprnd(repmat(mu_concat,1,samples));
    for i = 1:vehicles
        disturbed_mean_uavs(:,i,:) = exprnd(repmat(mu_concat,1,samples));
    end
