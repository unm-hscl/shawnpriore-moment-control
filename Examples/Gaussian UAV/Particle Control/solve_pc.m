...
for i = 1:3
    W_uav(:,:,i) = mvnrnd(zeros(size(sigma_concat,1),1),sigma_concat,N)';
end

W_mav =  mvnrnd(zeros(size(sigma_concat,1),1),sigma_concat,N)';
...
[P_target_pc, P_mav_pc, P_uav_pc] = verify(x_mean_pc, x_mav_mean, Wd_concat, sigma_concat, time_horizon, target_sets, r, 10000)
